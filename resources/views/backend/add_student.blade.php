        ...
        <div class="tabbable paper-shadow relative" data-z="0.5">
            ...
            <div class="tab-content">
                <div id="account" class="tab-pane active">
                    <form id="student-form" class="form-horizontal form-group teacher-form" enctype="multipart/form-data" method="post" action="{{ url('store_student') }}">
                        @csrf
                        ...
                        <div class="form-group margin-none">
                            <div class="col-md-offset-2 col-md-10">
                                <button type="submit" class="btn btn-primary paper-shadow relative" data-z="0.5" data-hover-z="1" data-animated>Add Student</button>
