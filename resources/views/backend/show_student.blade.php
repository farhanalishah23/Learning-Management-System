        ...
        <div class="tabbable paper-shadow relative" data-z="0.5">
            ...
            <div class="tab-content">
                <div id="account" class="tab-pane active">
                    <form id="student-form" class="form-horizontal form-group teacher-form" enctype="multipart/form-data" method="post" action="{{ url('update_student', $students->id) }}">
                        @csrf
                        @method('PUT')
                                ...
                                <div class="media v-middle">
                                    <div class="media-left">
                                        <div class="icon-block width-100 bg-grey-100">
                                            @if($students->image)
                                                <img id="image-preview" src="{{ asset('website') }}/{{$students->image}}"  alt="no image" class="img-circle width-80" >
                                            @else
                            ...
                            <div class="col-md-6">
                                <div class="form-control-material">
                                    <div class="input-group">
                                        <input class="form-control" name="name" type="text" placeholder="Enter Title" value="{{ $students->name ,old('name') }}">
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <div class="form-control-material">
                                    <div class="input-group">
                                        <input type="email" class="form-control" name="email" id="email" value="{{ $students->email,old('email') }}" placeholder="Enter Your Email" required>
                                    </div>
                                    @error('email')
                            ...
                            <div class="col-md-6">
                                <div class="form-control-material">
                                    <select class="form-control " name="status" id="status">
                                        <option  value="{{$students->id}}" selected>{{$students->status}}</option>
                        ...
                        <div class="form-group margin-none">
                            <div class="col-md-offset-2 col-md-10">
                                <button type="submit" class="btn btn-primary paper-shadow relative" data-z="0.5" data-hover-z="1" data-animated>Update Student</button>
                                <button  href="{{url('students')}}" class="btn btn-white paper-shadow relative" data-z="0.5" data-hover-z="1" data-animated>Cancel</button>
                            </div>
                        </div>
                    </form>
                </div>
